...
SECRET_KEY = "django-insecure-cx^mg$gg69xpm%gyc6+^*gl^e-9mtnd%evawou-xqjtv9r4!^c"
...
# # Virgin Media
# EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"
# EMAIL_HOST = "smtp.virginmedia.com"
# EMAIL_HOST_USER = os.getenv("EMAIL_USER_VM")
# EMAIL_HOST_PASSWORD = os.getenv("EMAIL_PASS_VM")
# EMAIL_PORT = 465
# # EMAIL_USE_TLS = True
# EMAIL_USE_SSL = True
